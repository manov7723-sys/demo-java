...
resource "aws_secretsmanager_secret" "db_credentials" {
  name                    = "this-dev-dev-db-db-credentials"
  description             = "Master credentials for the this-dev-dev-db postgres instance (managed by DeepAgent)"
  recovery_window_in_days = 0
  tags                    = {
    "ManagedBy" = "DeepAgent"
    "Database" = "this-dev-dev-db"
    "Engine" = "postgres"
    "Environment" = "dev"
  }
}
